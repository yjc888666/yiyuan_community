            ...
            <ol>
              <li>
                <input
                  ...
                  onblur="this.placeholder='请输入邮箱/手机号'"
                  v-model="usermail"
                />
              </li>
              <li>
  ...
  methods: {
    ...
    getCodes() {
      ...
      if (!this.code) {
        ...
        // window.location.href = `https://open.weixin.qq.com/connect/oauth2/authorize?appid=${appid}&redirect_uri=http%3A%2F%2Fmail.yidonghuayuan.com%2Fcommunity%2F%23%2Fland&response_type=code&scope=snsapi_userinfo&connect_redirect=1&state=STATE#wechat_redirect`;
        window.location.href = `https://open.weixin.qq.com/connect/oauth2/authorize?appid=${appid}&redirect_uri=http%3A%2F%2Fbnb.yidonghuayuan.com%2F%23%2Fland&response_type=code&scope=snsapi_userinfo&connect_redirect=1&state=STATE#wechat_redirect`;
        this.handleweixin();
      }
    },
    // 截取code
    ...
    async handleweixin() {
      ...
      if (res.data.msg == "操作成功") {
        var weixinsj = JSON.parse(localStorage.getItem("weixinsj"));
